...
#(resposta deve ser True ou False) e quantas vezes venceu um jogo. O programa deve imprimir True, 
#permitindo o ingresso do participante no clube, se:
